...
public class CustomerData {
	...
	public CustomerData(Long cust_id, String cust_fname, String cust_lname, Date cust_dob, String cust_address,
			char cust_gender, Date cust_cdate, long cust_aadhar, String cust_status, Date cust_luudate, int cust_luuser,
			Long cust_user_id) {
